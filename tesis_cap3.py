...
[IothersS1_HC,IothersS2_HC] = getIothers(FCtrt_HC_CL)
[IothersS1_SZ, IothersS2_SZ] = getIothers(FCtrt_SZ_CL)
...
name_s1 = 'Iothers_S1_WB'
name_s2 = 'Iothers_S2_WB'
...
name_s1 = 'DevFromHealth_S1'
name_s2 = 'DevFromHealth_S2'
HC_df.loc[:,name_s1] = DevFromHealth_S1_HC.tolist()
HC_df.loc[:,name_s2] = DevFromHealth_S2_HC.tolist()
SZ_df.loc[:,name_s1] = DevFromHealth_S1_SZ.tolist()
SZ_df.loc[:,name_s2] = DevFromHealth_S2_SZ.tolist()
...
for idx, network in enumerate(ATLAS.keys()):
    ...
    [IothersS1_HC,IothersS2_HC] = getIothers(FC_HC_ntw)
    [IothersS1_SZ, IothersS2_SZ] = getIothers(FC_SZ_ntw)
...
SZandHC_df.loc[:,"deltaATP"] = abs(SZandHC_df.ATPdose-SZandHC_df.ATPdose2)
#SZandHC_df.loc[:,"deltaTP"] = abs(SZandHC_df.TP-SZandHC_df.TP2)
SZandHC_df.loc[:,"Age2"] = SZandHC_df.Age*SZandHC_df.Age

#MEAN HECHO CON TODOS LOS SUJETOS PERO ANÁLISIS POR SEPARADO!!"
...
#    SZandHC_df.to_csv('Iselfs_dataframe.csv', index=False)

#%% ONE DF FOR EACH MODEL
...
# for x in SZandHC_df.ID[SZandHC_df.FDmax>0.5]:
#     print(x, file = f)
...
# plt.plot(SZandHC_df.index,SZandHC_df.Age)
# ax2.set_ylabel("Age")
# ax2=fig1.add_subplot(6,1,3)
# plt.plot(SZandHC_df.index,SZandHC_df.Age2)
# ax2.set_ylabel("Age2")
# ax3=fig1.add_subplot(6,1,4)
# plt.plot(SZandHC_df.index,SZandHC_df.Sex,".")
# ax3.set_ylabel("Sex")
# ax4=fig1.add_subplot(6,1,5)
# plt.plot(SZandHC_df.index,SZandHC_df.FDmax)    
# ax4.set_ylabel("Fdmax") 
# ax5=fig1.add_subplot(6,1,6)
# plt.plot(SZandHC_df.index,pd.Categorical(SZandHC_df.Group,['HC','SZ']))
...
DevHealth_df= pd.melt(SZandHC_df, id_vars=["ID","Age", "Age_demeaned", "Sex", "Group"], \
